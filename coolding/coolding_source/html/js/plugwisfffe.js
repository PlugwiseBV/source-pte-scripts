  ...
  angular.module('hardware', ['pascalprecht.translate', 'ngRoute', 'hardware.filters', 'hardware.services', 'hardware.controllers', 'hardware.directives', 'ngCookies', 'ngDragDrop']).config(function($httpProvider) {
    ...
    'JsonService', '$location', function(JsonService, $location) {
      if ($location.path() === '/index' || $location.path() === '') {
        return JsonService.serverRequests('../connect/last_connect.pte').then((function(fetch) {
          ...
          if (!$scope.valid) {
            ...
            devices = function(callback) {
              JsonService.serverRequests('https://smile.plugwise.net/?json=true&callback=JSON_CALLBACK&shortId=' + identifier, 'jsonp').then((function(fetch) {
                ...
                console.log("hhhh");
                JsonService.serverRequests('../coolding/plugincheck.pte', 'jsonp').then((function(fetch) {
                  console.log(" hhhhh");
                  console.log(fetch);
                  $scope.device.error = true;
                  return $scope.error_message = "Some of the Source plugin types are missing..";
                }));
